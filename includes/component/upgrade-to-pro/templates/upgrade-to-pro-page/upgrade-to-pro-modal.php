...
<div class="ts-upsell-overlay">
	...
	<div class="ts-upsell-content">
		<div class="ts-upsell-content__features">
			...
			<a href="https://www.tychesoftwares.com/products/order-delivery-date-pro-for-woocommerce-trial/" target="_blank" class="ts-upgrade-button">Upgrade and Unlock<img height="24" width="24" src="<?php echo $ts_new_tab; ?>" style="margin-left: 10px;color: white;"></a>
		</div>
	</div>
</div>