...
const DeliveryDate = ({ shippingMethod, updateSession, setLoading }) => {
    ...
    },[deliveryDate, isRequired, isEnabled, setDeliveryDate, shippingMethod, updateSession, setValidationErrors, clearValidationError ]);
