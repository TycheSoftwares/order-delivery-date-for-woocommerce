...
<table id="admin_delivery_fields" >
	<tr id="admin_delivery_date_field" >
		<td><label class ="orddd_lite_delivery_date_field_label"><?php echo esc_attr( $date_field_label ); ?>: </label></td>
		<td>
	...
	<?php if ( $time_slot_enabled ) { ?>
		...
		<tr id="admin_time_slot_field">
			<td><label for="orddd_lite_time_slot" class=""><?php echo esc_attr( $time_field_label ); ?>: </label></td>
	...
	<tr id='delivery_charges'>
		<td><label for='del_charges'><?php echo esc_attr( $fee_name ); ?></label></td>
