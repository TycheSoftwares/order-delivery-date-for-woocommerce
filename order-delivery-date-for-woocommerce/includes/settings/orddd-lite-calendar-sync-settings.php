...
class orddd_lite_calendar_sync_settings {
    ...
    public static function orddd_lite_calendar_event_location_callback( $args ) {
        echo '<input type="text" name="orddd_lite_calendar_event_location" id="orddd_lite_calendar_event_location" disabled readonly />';
        $html = '<label for="orddd_lite_calendar_event_location"> ' . $args[0] . '</label>';
        echo $html;
    } 
    ...
    public static function orddd_lite_calendar_event_summary_callback( $args ) {
        echo '<input id="orddd_lite_calendar_event_summary" name="orddd_lite_calendar_event_summary" size="90" type="text" disabled readonly/>';
    }
    ...
    public static function orddd_lite_calendar_event_description_callback( $args ) {
        echo '<textarea id="orddd_lite_calendar_event_description" name="orddd_lite_calendar_event_description" cols="90" rows="4" disabled readonly></textarea>';
        $html = '<label for="orddd_lite_calendar_event_description"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_add_to_calendar_order_received_page_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_add_to_calendar_order_received_page" id="orddd_lite_add_to_calendar_order_received_page" class="day-checkbox" disabled readonly />';
    ...
    public static function orddd_lite_add_to_calendar_customer_email_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_add_to_calendar_customer_email" id="orddd_lite_add_to_calendar_customer_email" class="day-checkbox" disabled readonly/>';
        $html = '<label for="orddd_lite_add_to_calendar_customer_email"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_add_to_calendar_my_account_page_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_add_to_calendar_my_account_page" id="orddd_lite_add_to_calendar_my_account_page" class="day-checkbox" disabled readonly/>';
        $html = '<label for="orddd_lite_add_to_calendar_my_account_page"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_calendar_in_same_window_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_calendar_in_same_window" id="orddd_lite_calendar_in_same_window" class="day-checkbox" disabled readonly/>';
        $html = '<label for="orddd_lite_calendar_in_same_window"> ' . $args[0] . '</label>';
        echo $html;
    } 
    ...
    public static function orddd_lite_calendar_sync_integration_mode_callback( $args ) {
        echo '<input type="radio" name="orddd_lite_calendar_sync_integration_mode" id="orddd_lite_calendar_sync_integration_mode" disabled readonly/>' . __( 'Sync Automatically', 'order-delivery-date' ) . '&nbsp;&nbsp;
            <input type="radio" name="orddd_lite_calendar_sync_integration_mode" id="orddd_lite_calendar_sync_integration_mode" disabled readonly/>' . __( 'Sync Manually', 'order-delivery-date' ) . '&nbsp;&nbsp;
            <input type="radio" name="orddd_lite_calendar_sync_integration_mode" id="orddd_lite_calendar_sync_integration_mode" disabled readonly/>' . __( 'Disabled', 'order-delivery-date' );
        
        $html = '<label for="orddd_lite_calendar_sync_integration_mode"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_calendar_key_file_name_callback( $args ) {
        echo '<input id="orddd_lite_calendar_details_1[orddd_lite_calendar_key_file_name]" name= "orddd_lite_calendar_details_1[orddd_lite_calendar_key_file_name]" size="90" type="text" disabled readonly/>';
        $html = '<label for="orddd_lite_calendar_key_file_name"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_calendar_service_acc_email_address_callback( $args ) {
        echo '<input id="ordddlite_calendar_details_1[orddd_lite_calendar_service_acc_email_address]" name="orddd_lite_calendar_details_1[orddd_lite_calendar_service_acc_email_address]" size="90" type="text" disabled readonly/>';
        $html = '<label for="orddd_lite_calendar_service_acc_email_address"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_calendar_id_callback( $args ) {
        echo '<input id="orddd_lite_calendar_details_1[orddd_lite_calendar_id]" name="orddd_lite_calendar_details_1[orddd_clite_alendar_id]" size="90" type="text" disabled readonly/>';
    ...
    public static function orddd_lite_admin_add_to_calendar_email_notification_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_admin_add_to_calendar_email_notification" id="orddd_lite_admin_add_to_calendar_email_notification" disabled readonly/>';
        $html = '<label for="orddd_lite_admin_add_to_calendar_email_notification"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_admin_add_to_calendar_delivery_calendar_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_admin_add_to_calendar_delivery_calendar" id="orddd_lite_admin_add_to_calendar_delivery_calendar" disabled readonly />';
        $html = '<label for="orddd_lite_admin_add_to_calendar_delivery_calendar"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_ics_feed_url_callback( $args ) {
        ...
        echo "<input type='button' class='save_button' id='add_new_ics_feed' name='add_new_ics_feed' value='" . __( 'Add New Ics feed url', 'order-delivery-date' ) ."' disabled>";
    ...
    public static function orddd_lite_real_time_import_callback( $args ) {
        echo '<input type="checkbox" name="orddd_lite_real_time_import" id="orddd_lite_real_time_import" class="day-checkbox" disabled readonly/>';
        $html = '<label for="orddd_lite_real_time_import"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_wp_cron_minutes_callback( $args ) {
        echo '<input id="orddd_lite_wp_cron_minutes" name= "orddd_lite_wp_cron_minutes" type="text" disabled readonly/>';
        $html = '<label for="orddd_lite_wp_cron_minutes"> ' . $args[0] . '</label>';
        echo $html;
    }
}
?>