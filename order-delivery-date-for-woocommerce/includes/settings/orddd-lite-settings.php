...
include_once( 'orddd-lite-date-settings.php' );
include_once( 'orddd-lite-shipping-days-settings.php' );
include_once( 'orddd-lite-appearance-settings.php' );
include_once( 'orddd-lite-holidays-settings.php' );
include_once( 'orddd-lite-calendar-sync-settings.php' );
...
class orddd_lite_settings {
    ...
    public static function orddd_lite_order_delivery_date_settings() {
        ...
        <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
            ...
            <a href="admin.php?page=order_delivery_date_lite&action=shipping_based" class="nav-tab <?php echo $active_shipping_based; ?>"> <?php _e( 'Custom Delivery Settings', 'order-delivery-date' ); ?> </a>
            <a href="admin.php?page=order_delivery_date_lite&action=calendar_sync_settings" class="nav-tab <?php echo $calendar_sync_settings; ?>"> <?php _e( 'Google Calendar Sync', 'order-delivery-date' ); ?> </a>
